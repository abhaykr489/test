                                            ...
                                            ://else
                                             (this.state.route==='admin')? (
                                                ...
                                                (this.state.route==='search')? (
                                                      <div>
                                                          <Navigation route={this.state.route}  isSignedin={this.state.isSignedin}/>
                                                  
                                                          {
                                                            
                                                            <Card SetBus={this.SetBus} routeids={this.state.routeid} from={this.state.from} to={this.state.to} sbus={true} onRouteChange={this.onRouteChange} id={bus[0].id} name={bus[0].name} />
                                                          }
                                                      </div>
                                             ...
                                             (
                                                <div>
                                                    <Navigation route={this.state.route} onRouteChange={this.onRouteChange} isSignedin={this.state.isSignedin}/>
                                                    <Seat onRouteChange={this.onRouteChange} bus={this.state.selbus}  seldate={this.state.traveldate} routeid={this.state.selbus.routeid} SetBus={this.SetBus} setPNR={this.setPNR} setbooked={this.setbooked} />                  
                                                </div>
